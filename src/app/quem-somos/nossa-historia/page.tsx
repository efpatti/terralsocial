...
const timelineEvents = [
  {
    ...
    description: "Começamos atividades artístico-pedagógicas na Comunidade do Terreirão. Era uma grande brincadeira - uma forma de matar o tempo, de nos divertir com os amigos. Ensaiávamos no quintal da Janete ou na casa de alguém.",
    icon: Sparkles,
    color: "#499D4B"
  },
  {
    ...
    description: "O grupo de teatro nasce como alegria entre vizinhos. Quando começamos, era diversão pura - as pessoas se divertindo, brincando, fazendo coisas que criança gosta de fazer. Mas aos poucos fomos vendo que tinha uma outra história por trás.",
    icon: Theater,
    color: "#3ca0e7"
  },
  {
    ...
    description: "Sem recursos, catamos madeira nas obras do Recreio para fazer o tablado. Éramos muito jovens e só sabíamos estar no palco - não sabíamos de produção nem administração. Mas fizemos acontecer com o que tínhamos.",
    icon: Award,
    color: "#8B5CF6"
  },
  {
    ...
    description: "Conseguimos um espaço enorme na Cresce Amor através da Nena Ribeiro, que sempre apoiou e nunca disse não. Chegavam doações de figurinos e fantasias. Foi uma das que mais acreditou na gente.",
    icon: Handshake,
    color: "#F59E0B"
  },
  {
    ...
    description: "O Terreirão entrou no mapa cultural do Rio. Saíamos para nos apresentar e víamos crianças sem as oportunidades que tínhamos. Mas chegou a hora de escolher: botar comida no prato ou continuar a brincadeira. Cada um foi buscando seu rumo.",
    icon: TrendingUp,
    color: "#E74C3C"
  },
  {
    ...
    description: "O Fazendo Acontecendo se tornou uma escola e uma família. Quem fez parte trilha um caminho do bem, de ação social. Aprendemos que teatro não é só brincar - ele ensina a trabalhar no coletivo, dá voz a quem ninguém quer escutar.",
    icon: GraduationCap,
    color: "#499D4B"
  },
  {
    ...
    description: "Seguimos firmes no propósito: criar oportunidades, fortalecer a comunidade e mostrar que o morador da favela pode chegar lá fora e ter voz. O teatro alimenta a alma e abre portas. É uma válvula de escape, é psicólogo, é tudo.",
    icon: Star,
    color: "#3ca0e7"
  }
];

function TimelineItem({ event, index, isLast }: { event: typeof timelineEvents[number]; index: number; isLast: boolean }) {
      ...
      <div className="flex flex-col items-center flex-shrink-0">
        ...
        {!isLast && (
          <div
            ...
            style={{
              background: `linear-gradient(to bottom, ${event.color}, ${timelineEvents[index + 1].color})`
            }}
          />
        )}
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            32 anos construindo cultura e transformando vidas no Terreirão - com alegrias, desafios e muita união
          </p>
        </motion.div>
  ...
  const impacts = [
    {
      ...
      description: "Fazemos formação e conectamos a comunidade a oportunidades reais. O teatro ensina comunicação, trabalho em equipe e abre portas para bons empregos.",
      color: "#499D4B"
    },
    {
      icon: Heart,
      title: "Transformação Pessoal",
      description: "O teatro tem sido válvula de escape e psicólogo para muitos. Ele alimenta a alma e resgata a autoestima através das artes e oficinas.",
      color: "#E74C3C"
    },
    {
      icon: Target,
      title: "Voz para Quem Ninguém Escuta",
      description: "Mostramos que o morador da comunidade pode chegar lá fora e ter voz. Contamos nossas histórias e quebramos estereótipos - não somos pobres coitados.",
      color: "#3ca0e7"
    },
    {
      icon: Users,
      title: "Trabalho no Coletivo",
      description: "Não pensamos 'quero para mim', mas 'quero para todos'. O sol que brilha para um, vai brilhar para todos que estão ali naquele momento.",
      color: "#F59E0B"
    }
  ];
    ...
    <section className="py-20 bg-[#FFFBF5]">
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            A cultura é um instrumento socializador - é a magia do teatro de cativar qualquer ser humano
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="relative z-10 text-center text-white">
              ...
              <p className="text-lg mb-8 opacity-95 max-w-2xl mx-auto">
                Apoie, participe ou venha nos visitar - construímos juntos uma cidade mais humana
              </p>
